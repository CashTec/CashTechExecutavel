...
wget https://github.com/CashTec/CashTechExecutavel/raw/main/cashtech-jar-1.0-SNAPSHOT-jar-with-dependencies.jar
echo "$(tput setaf 10)[Bot assistant]:$(tput setaf 7) Iniciando a execução da aplicação"
java -jar ./cashtech-jar-1.0-SNAPSHOT-jar-with-dependencies.jar
